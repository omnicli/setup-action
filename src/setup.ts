...
import { omniDataHome, setEnv } from './env'
...
async function getReleaseUrl(
  ...
  actionsCore.setOutput('version', release.tag_name)
...
export const omniVersion = async (): Promise<number> => omni(['--version'])
export const omniUp = async (): Promise<number> =>
